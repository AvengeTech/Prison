<?php namespace prison\enchantments\effects\entities;
...
class CreepySilverfish extends Living{
	...
	public function __construct(Location $location, $deathposition){
	...
	public function attack(EntityDamageEvent $source) : void{
		...
		$this->getWorld()->addSound($this->getPosition(), new PlaySound($this->getPosition(), "mob.silverfish.kill"));
		$this->flagForDespawn();
	}
