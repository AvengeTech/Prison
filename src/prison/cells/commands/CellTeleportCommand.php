...
class CellTeleportCommand extends Command{
	...
	public function execute(CommandSender $sender, string $commandLabel, array $args){
		...
		if(count($args) !== 3){
			$sender->sendMessage(TextFormat::RI . "Usage: /celltp <corridor> <row> <cell>");
			return false;
		}
		...
		$sender->sendMessage(TextFormat::GI . "Teleported to " . TextFormat::YELLOW . "Cell " . $cell->getName());
