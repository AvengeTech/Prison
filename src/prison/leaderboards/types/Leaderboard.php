...
use prison\Prison;
use prison\leaderboards\Structure as LB;
...
abstract class Leaderboard extends Position{
	...
	public function inLeft(Player $player) : bool{ //HACK!
		return isset(Prison::getInstance()->getLeaderboards()->left[$player->getName()]);
	}
